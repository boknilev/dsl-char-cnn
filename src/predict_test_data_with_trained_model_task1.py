...
from data import load_test_file, write_predictions_to_file, write_probabilities_to_file, load_labels, task1_labels_file, get_task1_alphabet
...
evaluation_test_file = "../data/A.txt"
predictions_file = evaluation_test_file + ".large.morehidden.pred"
probabilities_file = evaluation_test_file+ ".large.morehidden.prob"
model_file = "cnn_model_gpu_multifilter_large_morehidden_task1.hdf5"
